...
* predictions are done in <a href="https://github.com/jlomako/prophet-bot">prophet-bot</a>
* matching problem with color palette in chart vs Quebec map -> maps shows only surrounding hospitals now
